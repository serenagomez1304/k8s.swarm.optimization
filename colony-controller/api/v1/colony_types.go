...
type FoodsourceStatus struct {
	Foodsource        []int32 `json:"fs_vector,omitempty"`
...
type ColonyStatus struct {
	...
	EmployeeBeeCycleStatus map[string]string           `json:"completedEmployeeCycleStatus,omitempty"`
	OnlookerBeeCycles      int32                       `json:"completedOnlookerCycles,omitempty"`
	OnlookerBeeCycleStatus map[string]string           `json:"completedOnlookerCycleStatus,omitempty"`
